...
8:'本库需要Underscore，如果在服务器环境，它是不存在的。在这里加载它',
9:'为backbone，持有jQuery，Zepto，Ender，或“我的库”（开玩笑）拥有的$变量。 ',
...
195:'设置__super__属性，如果以后要用到父原型的时候可以方便取到',
196:'为model,collection,router,view,history添加extend方法',
197:'当url必要且为空时，抛一个错误异常',
198:'包装model选项中的错误回调函数'
};
